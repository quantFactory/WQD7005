...
_ARBFMT_1 = PUT( Attrition , BEST1.);
 %DMNORMCP( _ARBFMT_1, F_Attrition );
...
*****  RESIDUALS R_ *************;
IF  F_Attrition  NE '1' 
AND F_Attrition  NE '0'  THEN DO; 
        R_Attrition1  = .;
        R_Attrition0  = .;
 END;
 ELSE DO;
       R_Attrition1  =  -P_Attrition1 ;
       R_Attrition0  =  -P_Attrition0 ;
       SELECT( F_Attrition  );
          WHEN( '1'  ) R_Attrition1  = R_Attrition1  +1;
          WHEN( '0'  ) R_Attrition0  = R_Attrition0  +1;
       END;
 END;
