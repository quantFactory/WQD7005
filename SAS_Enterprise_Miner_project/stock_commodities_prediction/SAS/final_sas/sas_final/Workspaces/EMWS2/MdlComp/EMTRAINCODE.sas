...
retain parent "Tree10" MODEL "Tree10" MODELDESCRIPTION "Decision Tree (10)" TARGETLABEL "";
set EMWS2.Tree10_EMRANK;
where upcase(TARGET) = upcase("stockprice");
run;
...
retain parent "Reg5" MODEL "Reg5" MODELDESCRIPTION "Regression (5)" TARGETLABEL "";
set EMWS2.Reg5_EMRANK;
where upcase(TARGET) = upcase("stockprice");
run;
data EMWS2.MdlComp_EMRANK;
